  ...
  return {
    ...
    module: {
      rules: [
        ...
        {
          test: /\.pcss$/,
          use: webpackConfigFactory.loaders.styleConfigFactory({raw: {stylesheetNameAttribute: 'enhanced-dom-title'}, sourceMap: !isProduction, parser: 'postcss', typedStyles: true, modules: true})
        },
        {
          test: /\.css$/,
